...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "nahuic-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "nahuic-tfremotestate" {
  bucket = aws_s3_bucket.nahuic-tfremotestate.id
